            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white py-3">
                    <h4 class="mb-0">
                        ...
                        <span class="badge bg-primary ms-2"><?php echo e($cartItems->count()); ?> items</span>
                    </h4>
                </div>
                <div class="card-body">
                    <?php if($cartItems->count() > 0): ?>
                        <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="cart-item border-bottom pb-3 mb-3" data-item-id="<?php echo e($item->id); ?>">
                                <div class="row align-items-center">
                                    <div class="col-md-2">
                                        <img src="<?php echo e($item->product_data['image'] ?? '/images/placeholder-product.jpg'); ?>" 
                                             alt="<?php echo e($item->product_data['name']); ?>" 
                                             class="img-fluid rounded"
                                             style="height: 80px; object-fit: cover;">
                                    </div>
                                    <div class="col-md-4">
                                        <h6 class="mb-1">
                                            <a href="<?php echo e(route('products.show', $item->product_data['slug'])); ?>" class="text-decoration-none text-dark">
                                                <?php echo e($item->product_data['name']); ?>

                                            </a>
                                        </h6>
                                        <?php if($item->variant): ?>
                                            <small class="text-muted"><?php echo e($item->variant->title); ?></small>
                                        <?php endif; ?>
                                        <div class="text-muted small">
                                            Sold by: <?php echo e($item->product->seller->store_name); ?>
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-group input-group-sm" style="max-width: 120px;">
                                            ...
                                            <input type="number" class="form-control text-center quantity-input" 
                                                   value="<?php echo e($item->quantity); ?>" min="1" max="99">
                                    ...
                                    <div class="col-md-2 text-center">
                                        <div class="fw-bold">$<?php echo e(number_format($item->unit_price, 2)); ?></div>
                    ...
                    <?php if($cartItems->count() > 0): ?>
                        <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-between">
                                <h6>Total:</h6>
                                <h6 class="text-primary">$<?php echo e(number_format($total, 2)); ?></h6>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateQuantity(input) {
        ...
        fetch(`<?php echo e(route('cart.update', ':id')); ?>`.replace(':id', itemId), {
            method: 'PUT',
            headers: {
    ...
    function removeItem(itemId, cartItemElement) {
        fetch(`<?php echo e(route('cart.remove', ':id')); ?>`.replace(':id', itemId), {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\babywear\resources\views/cart/index.blade.php ENDPATH**/ ?>