...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="<?php echo e(route('admin.categories')); ?>" class="btn btn-outline-secondary">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-check form-switch ms-3">
                            ...
                            <input class="form-check-input" type="checkbox" name="is_featured" id="isFeatured" value="1" <?php echo e(old('is_featured') ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex gap-2 mt-4">
                    ...
                    <a href="<?php echo e(route('admin.categories')); ?>" class="btn btn-outline-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\babywear\resources\views/admin/categories/create.blade.php ENDPATH**/ ?>