                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                ...
                                <a href="{{ route('products.index', ['sale' => true]) }}" class="btn btn-light btn-lg">View Sale</a>
                            </div>
                            <div class="col-lg-6 text-center">
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="text-center">
                        <a href="#" class="text-decoration-none">
                            ...
                            <h6 class="text-dark">{{ $seller->store_name }}</h6>
                            <div class="text-warning small mb-1">
                                <i class="bi bi-star-fill"></i> {{ number_format($seller->rating, 1) }}
                                <small class="text-muted">({{ $seller->review_count }})</small>
                            </div>
