                                ...
                                <div class="card product-card h-100 border-0 shadow-sm">
                                    <div class="product-image-container position-relative">
                                        ...
                                        <div class="product-actions position-absolute top-50 start-50 translate-middle">
                                            <button class="btn btn-light btn-sm me-2 quick-view" data-product-id="{{ $product->id }}">
                                                <i class="bi bi-eye"></i>
                                            </button>
                                            @auth
                                                <button class="btn btn-light btn-sm add-to-wishlist" data-product-id="{{ $product->id }}">
